...
variable "enable_logging" {
  description = "Habilitar logging de acceso para CloudFront"
  type        = bool
  default     = false
}

variable "log_bucket_domain_name" {
  description = "Nombre de dominio del bucket S3 para logs de CloudFront (ej: bucketname.s3.amazonaws.com)"
  type        = string
  default     = null
}

variable "log_prefix" {
  description = "Prefijo para los archivos de log en el bucket S3"
  type        = string
